        ...
        child: Column(
          children: [
            ClipRRect(
              ...
              child: Image.asset('assets/temp/user.png', width: 90, height: 90),
            ),
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  child:
                      const Icon(Icons.favorite_border, color: AppColors.font),
                ),
                const Text(
                  '9',
                ...
                ElevatedButton(
                  ...
                  child:
                      const Icon(Icons.message_outlined, color: AppColors.font),
                ),
                const Text(
                  '14',
                  style: TextStyle(color: AppColors.font),
